...
typedef enum X86Opcode {
    ...
    X86OP_SETO_Eb       = 0x0F90,
    X86OP_SETNO_Eb      = 0x0F91,
    X86OP_SETB_Eb       = 0x0F92,
    X86OP_SETAE_Eb      = 0x0F93,
    X86OP_SETZ_Eb       = 0x0F94,
    X86OP_SETNZ_Eb      = 0x0F95,
    X86OP_SETBE_Eb      = 0x0F96,
    X86OP_SETA_Eb       = 0x0F97,
    X86OP_SETS_Eb       = 0x0F98,
    X86OP_SETNS_Eb      = 0x0F99,
    X86OP_SETP_Eb       = 0x0F9A,
    X86OP_SETNP_Eb      = 0x0F9B,
    X86OP_SETL_Eb       = 0x0F9C,
    X86OP_SETGE_Eb      = 0x0F9D,
    X86OP_SETLE_Eb      = 0x0F9E,
    X86OP_SETG_Eb       = 0x0F9F,
