...
static const uint8_t expected_code[] = {
    ...
    0x66,0x45,0x0F,0x6E,0xC8,           // movd %r8d,%xmm9
    0x41,0xB8,0x00,0x00,0x00,0x40,      // mov $0x40000000,%r8d
    0x66,0x45,0x0F,0x6E,0xD0,           // movd %r8d,%xmm10
    0x45,0x0F,0x14,0xC9,                // unpcklps %xmm9,%xmm9
    0xF3,0x45,0x0F,0x7E,0xC9,           // movq %xmm9,%xmm9
    0x45,0x0F,0x14,0xD2,                // unpcklps %xmm10,%xmm10
    0xF3,0x45,0x0F,0x7E,0xD2,           // movq %xmm10,%xmm10
    0x45,0x0F,0x28,0xD9,                // movaps %xmm9,%xmm11
    0x45,0x0F,0xC2,0xDA,0x03,           // cmpunordps %xmm10,%xmm11
