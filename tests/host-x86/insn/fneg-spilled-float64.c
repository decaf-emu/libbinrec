...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_FNEG, reg3, reg1, 0, 0));
    for (int i = 0; i < lenof(dummy_regs); i++) {
...
static const uint8_t expected_code[] = {
    ...
    0x48,0xB8,0x00,0x00,0x00,0x00,0x00, // mov $0x4000000000000000,%rax
      0x00,0x00,0x40,
    0x66,0x4C,0x0F,0x6E,0xF0,           // movq %rax,%xmm14
    0x48,0xB8,0x00,0x00,0x00,0x00,0x00, // mov $0x8000000000000000,%rax
      0x00,0x00,0x80,
    0x66,0x4C,0x0F,0x6E,0xF0,           // movq %rax,%xmm14
    0xF2,0x44,0x0F,0x10,0x3C,0x24,      // movsd (%rsp),%xmm15
