...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_STORE_BR, 0, reg5, reg6, 0));
...
static const uint8_t expected_code[] = {
    ...
    0x44,0x0F,0x38,0xF1,0x07,           // movbe %r8d,(%rdi)
    0x45,0x33,0xC9,                     // xor %r9d,%r9d
    0x45,0x33,0xD2,                     // xor %r10d,%r10d
    0x45,0x0F,0x38,0xF1,0x11,           // movbe %r10d,(%r9)
    0x45,0x33,0xDB,                     // xor %r11d,%r11d
    0x33,0xDB,                          // xor %ebx,%ebx
    0x41,0x0F,0x38,0xF1,0x1B,           // movbe %ebx,(%r11)
    0x5B,                               // pop %rbx
    0xC3,                               // ret
};
