...
static const uint8_t expected_code[] = {
    ...
    0xE9,0x5D,0x00,0x00,0x00,           // jmp L1
    0xB9,0x04,0x00,0x00,0x00,           // L0: mov $4,%ecx
    0x0F,0x1F,0x05,0x01,0x00,0x00,0x00, // nopl 1(%rip)
    0xE9,0x52,0x00,0x00,0x00,           // jmp L2
    ...
    0x44,0x89,0x97,0x14,0x01,0x00,0x00, // mov %r10d,0x114(%rdi)
    0x45,0x8B,0xDA,                     // mov %r10d,%r11d
    0x45,0x8B,0xD1,                     // mov %r9d,%r10d
