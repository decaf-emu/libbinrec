...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(spiller = rtl_alloc_register(unit, RTLTYPE_INT64));
...
static const uint8_t expected_code[] = {
    ...
    0x44,0x0F,0x29,0x7C,0x24,0x20,      // movaps %xmm15,32(%rsp)
    ...
    0x4C,0x8B,0x74,0x24,0x10,           // mov 16(%rsp),%r14
    0x48,0x8B,0x44,0x24,0x08,           // mov 8(%rsp),%rax
    0xF0,0x4D,0x0F,0xB1,0x37,           // lock cmpxchg %r14,(%r15)
    0x4C,0x8B,0xF0,                     // mov %rax,%r14
    0x66,0x4C,0x0F,0x7E,0xF8,           // movq %xmm15,%rax
    0x44,0x0F,0x28,0x7C,0x24,0x20,      // movaps 32(%rsp),%xmm15
    0x48,0x83,0xC4,0x38,                // add $56,%rsp
    0x41,0x5F,                          // pop %r15
    0x41,0x5E,                          // pop %r14
    0x41,0x5D,                          // pop %r13
    0x41,0x5C,                          // pop %r12
