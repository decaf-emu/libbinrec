...
static const uint8_t expected_code[] = {
    ...
    0x4C,0x89,0x24,0x24,                          // mov %r12,(%rsp)
    0x4C,0x89,0x64,0x24,0x08,                     // mov %r12,8(%rsp)
    0x4C,0x89,0x64,0x24,0x10,                     // mov %r12,16(%rsp)
    0x4C,0x89,0x64,0x24,0x18,                     // mov %r12,24(%rsp)
    0x4C,0x89,0x64,0x24,0x20,                     // mov %r12,32(%rsp)
    0x4C,0x89,0x64,0x24,0x28,                     // mov %r12,40(%rsp)
    0x4C,0x89,0x64,0x24,0x30,                     // mov %r12,48(%rsp)
    0x4C,0x89,0x64,0x24,0x38,                     // mov %r12,56(%rsp)
    0x4C,0x89,0x64,0x24,0x40,                     // mov %r12,64(%rsp)
    0x4C,0x89,0x64,0x24,0x48,                     // mov %r12,72(%rsp)
    0x4C,0x89,0x64,0x24,0x50,                     // mov %r12,80(%rsp)
    0x4C,0x89,0x64,0x24,0x58,                     // mov %r12,88(%rsp)
    0x4C,0x89,0x64,0x24,0x60,                     // mov %r12,96(%rsp)
    0x4C,0x89,0x64,0x24,0x68,                     // mov %r12,104(%rsp)
    0x4C,0x89,0x64,0x24,0x70,                     // mov %r12,112(%rsp)
    0x4C,0x89,0x64,0x24,0x78,                     // mov %r12,120(%rsp)
    0x41,0xBC,0x01,0x00,0x00,0x00,                // mov $1,%r12d
    0x4C,0x89,0xA4,0x24,0x80,0x00,0x00,0x00,      // mov %r12,128(%rsp)
    0x41,0xBC,0x02,0x00,0x00,0x00,                // mov $2,%r12d
    0x4C,0x89,0xA4,0x24,0x88,0x00,0x00,0x00,      // mov %r12,136(%rsp)
