...
static const uint8_t expected_code[] = {
    ...
    0x00,0x00,0x40,0x00,0x00,0x00,0x40,0x00, // (data)
    ...
    0x0F,0x5A,0xD1,                     // cvtps2pd %xmm1,%xmm2
    0x0F,0xAE,0x1C,0x24,                // stmxcsr (%rsp)
    ...
    0x0F,0xC2,0xD1,0x03,                // cmpunordps %xmm1,%xmm2
    0x0F,0x28,0xD9,                     // movaps %xmm1,%xmm3
    0x0F,0x54,0x15,0xB3,0xFF,0xFF,0xFF, // andps -77(%rip),%xmm2
