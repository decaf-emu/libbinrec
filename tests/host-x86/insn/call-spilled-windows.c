...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_CALL, 0, reg2, reg1, reg3));
...
static const uint8_t expected_code[] = {
    ...
    0x0F,0xAE,0x5C,0x24,0x28,           // stmxcsr 40(%rsp)
    0x41,0x8B,0xCD,                     // mov %r13d,%ecx
    0x41,0x8B,0xD6,                     // mov %r14d,%edx
    0x48,0x8B,0x44,0x24,0x20,           // mov 32(%rsp),%rax
    0xFF,0xD0,                          // call *%rax
    0x0F,0xAE,0x54,0x24,0x28,           // ldmxcsr 40(%rsp)
