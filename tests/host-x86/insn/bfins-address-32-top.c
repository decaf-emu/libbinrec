...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_BFINS, reg3, reg1, reg2, 32 | 32<<8));
...
static const uint8_t expected_code[] = {
    ...
    0x48,0xBE,0xFF,0xFF,0xFF,0xFF,0x00, // mov $0x00000000FFFFFFFF,%rsi
      0x00,0x00,0x00,
    0x48,0x23,0xF1,                     // and %rcx,%rsi
    0x48,0x8B,0xFA,                     // mov %rdx,%rdi
    0x48,0xC1,0xE7,0x20,                // shl $32,%rdi
