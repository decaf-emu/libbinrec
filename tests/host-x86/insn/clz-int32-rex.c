...
static const uint8_t expected_code[] = {
    ...
    0x44,0x0F,0xBD,0xC7,                // bsr %edi,%r8d
    0x41,0xB9,0x3F,0x00,0x00,0x00,      // mov $63,%r9d
    0x45,0x0F,0x44,0xC1,                // cmovz %r9d,%r8d
    0x41,0x83,0xF0,0x1F,                // xor $31,%r8d
    0x41,0xBB,0x03,0x00,0x00,0x00,      // mov $3,%r11d
    0x41,0x0F,0xBD,0xDB,                // bsr %r11d,%ebx
    0xBD,0x3F,0x00,0x00,0x00,           // mov $63,%ebp
    0x0F,0x44,0xDD,                     // cmovz %ebp,%ebx
    0x83,0xF3,0x1F,                     // xor $31,%ebx
