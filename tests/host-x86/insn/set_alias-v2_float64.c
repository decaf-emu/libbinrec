...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(alias = rtl_alloc_alias_register(unit, RTLTYPE_V2_FLOAT64));
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_VBROADCAST, reg3, reg2, 0, 0));
...
static const uint8_t expected_code[] = {
    ...
    0x48,0xBA,0x00,0x00,0x00,0x00,0x00, // mov $0x4000000000000000,%rdx
      0x00,0x00,0x40,
    0x66,0x48,0x0F,0x6E,0xDA,           // movq %rdx,%xmm3
    0xF2,0x0F,0x12,0xDB,                // movddup %xmm3,%xmm3
    0x0F,0x29,0x99,0x34,0x12,0x00,0x00, // movaps %xmm3,0x1234(%rcx)
