...
static int add_rtl(RTLUnit *unit)
{
    ...
    /* reg4 should not reuse reg2 so its host register is available as a
     * temporary for reloading reg1. */
...
static const uint8_t expected_code[] = {
    ...
    0x41,0xBD,0x03,0x00,0x00,0x00,      // mov $3,%r13d
    0x44,0x89,0x6C,0x24,0x04,           // mov %r13d,4(%rsp)
    0x44,0x8B,0x2C,0x24,                // mov (%rsp),%r13d
    0x45,0x3B,0xEE,                     // cmp %r14d,%r13d
    0x41,0x0F,0x94,0xC5,                // setz %r13b
    0x45,0x0F,0xB6,0xED,                // movzbl %r13b,%r13d
