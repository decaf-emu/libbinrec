...
{
    unit->handle->common_opt |= BINREC_OPT_NATIVE_IEEE_NAN;
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_NOP, 0, reg4, reg6, 0));
...
static const uint8_t expected_code[] = {
    ...
    0x0F,0x59,0xD1,                     // mulps %xmm1,%xmm2
    0x0F,0x58,0xD3,                     // addps %xmm3,%xmm2
