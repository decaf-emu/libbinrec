...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_FNMADD, reg7, reg4, reg5, reg6));
...
static const uint8_t expected_code[] = {
    ...
    0x0F,0x59,0xE2,                     // mulps %xmm2,%xmm4
    0x0F,0x57,0x25,0xB3,0xFF,0xFF,0xFF, // xorps -77(%rip),%xmm4
    0x0F,0x58,0xE3,                     // addps %xmm3,%xmm4
