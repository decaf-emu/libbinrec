...
static const uint8_t expected_code[] = {
    ...
    0x66,0x44,0x0F,0x38,0xF0,0x07,      // movbe (%rdi),%r8w
    0x45,0x0F,0xB7,0xC0,                // movzwl %r8w,%r8d
    0x45,0x33,0xC9,                     // xor %r9d,%r9d
    0x66,0x45,0x0F,0x38,0xF0,0x11,      // movbe (%r9),%r10w
    0x45,0x0F,0xB7,0xD2,                // movzwl %r10w,%r10d
    0x45,0x33,0xDB,                     // xor %r11d,%r11d
    0x66,0x41,0x0F,0x38,0xF0,0x1B,      // movbe (%r11),%bx
    0x0F,0xB7,0xDB,                     // movzwl %bx,%ebx
    0x5B,                               // pop %rbx
    0xC3,                               // ret
};
