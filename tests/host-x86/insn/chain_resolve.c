...
static const uint8_t expected_code[] = {
    ...
    0x41,0x5F,                          // pop %r15
    0xFF,0xE0,                          // jmp *%rax
    0xBA,0x03,0x00,0x00,0x00,           // L0: mov $3,%edx
    0x48,0x85,0xD2,                     // test %rdx,%rdx
    0x74,0x22,                          // jz L1
    0x48,0x8B,0xC2,                     // mov %rdx,%rax
    0x48,0xC1,0xE8,0x30,                // shr $48,%rax
    0x74,0x07,                          // jz L2
    0x66,0x89,0x05,0xD7,0xFF,0xFF,0xFF, // mov %ax,-41(%rip)
    0x48,0xC1,0xE2,0x10,                // shl $16,%rdx
    0x48,0x81,0xCA,0x49,0xBF,0x00,0x00, // or $0xBF49,%rdx
    0x48,0x89,0x15,0xBD,0xFF,0xFF,0xFF, // mov %rdx,-67(%rip)
