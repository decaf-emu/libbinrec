...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_STORE_I16_BR, 0, reg5, reg6, 0));
...
static const uint8_t expected_code[] = {
    ...
    0x66,0x41,0xC1,0xC8,0x08,           // ror $8,%r8w
    0x66,0x44,0x89,0x07,                // mov %r8w,(%rdi)
    0x66,0x41,0xC1,0xC8,0x08,           // ror $8,%r8w
    0x45,0x33,0xC9,                     // xor %r9d,%r9d
    0x45,0x33,0xD2,                     // xor %r10d,%r10d
    0x66,0x41,0xC1,0xCA,0x08,           // ror $8,%r10w
    0x66,0x45,0x89,0x11,                // mov %r10w,(%r9)
    0x66,0x41,0xC1,0xCA,0x08,           // ror $8,%r10w
    0x45,0x33,0xDB,                     // xor %r11d,%r11d
    0x33,0xDB,                          // xor %ebx,%ebx
    0x66,0xC1,0xCB,0x08,                // ror $8,%bx
    0x66,0x41,0x89,0x1B,                // mov %bx,(%r11)
    0x66,0xC1,0xCB,0x08,                // ror $8,%bx
    0x5B,                               // pop %rbx
    0xC3,                               // ret
};
