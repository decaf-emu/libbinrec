...
static const uint8_t expected_code[] = {
    ...
    0x75,0x07,                          // jnz L0
    0x0F,0x54,0x15,0x9E,0xFF,0xFF,0xFF, // andps -98(%rip),%xmm2
    0x0F,0xAE,0x14,0x24,                // L0: ldmxcsr (%rsp)
    0x0F,0xAE,0x1C,0x24,                // stmxcsr (%rsp)
    0x0F,0x2E,0xD2,                     // ucomiss %xmm2,%xmm2
    0xF3,0x0F,0x5A,0xCA,                // cvtss2sd %xmm2,%xmm1
    0x7B,0x13,                          // jnp L1
    0x66,0x0F,0x7E,0xD0,                // movd %xmm2,%eax
    0xF7,0xC0,0x00,0x00,0x40,0x00,      // test $0x400000,%eax
    0x75,0x07,                          // jnz L1
    0x0F,0x54,0x0D,0x8A,0xFF,0xFF,0xFF, // andps -118(%rip),%xmm1
    0x0F,0xAE,0x14,0x24,                // L1: ldmxcsr (%rsp)
