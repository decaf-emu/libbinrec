...
static int add_rtl(RTLUnit *unit)
{
    ...
    /* The temporary for the extraction mask should not clobber ECX. */
    EXPECT(rtl_add_insn(unit, RTLOP_BFEXT, reg5, reg4, 0, 8 | 48<<8));
...
static const uint8_t expected_code[] = {
    ...
    0x48,0xC1,0xE8,0x08,                // shr $8,%rax
    0x48,0xBA,0xFF,0xFF,0xFF,0xFF,0xFF, // mov $0x0000FFFFFFFFFFFF,%rdx
      0xFF,0x00,0x00,
    0x48,0x23,0xC2,                     // and %rdx,%rax
