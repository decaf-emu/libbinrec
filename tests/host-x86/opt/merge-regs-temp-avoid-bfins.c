...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_LOAD_IMM, reg5, 0, 0, 5));  // Gets EDX.
    EXPECT(reg6 = rtl_alloc_register(unit, RTLTYPE_INT64));
    /* The temporary for the insertion mask should not clobber ECX. */
    EXPECT(rtl_add_insn(unit, RTLOP_BFINS, reg6, reg4, reg5, 8 | 48<<8));
...
static const uint8_t expected_code[] = {
    ...
    0x48,0xBE,0xFF,0x00,0x00,0x00,0x00, // mov $0xFF000000000000FF,%rsi
      0x00,0x00,0xFF,
    0x48,0x23,0xC6,                     // and %rsi,%rax
    0x48,0xC1,0xE2,0x10,                // shl $16,%rdx
    0x48,0xC1,0xEA,0x08,                // shr $8,%rdx
    0x48,0x0B,0xC2,                     // or %rdx,%rax
