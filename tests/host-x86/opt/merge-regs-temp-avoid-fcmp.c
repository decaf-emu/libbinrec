...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_LOAD_IMM, reg2, 0, 0, 0x40000000));  // Gets XMM0.
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_LOAD_IMM, reg3, 0, 0, 0x40400000));  // Spilled.
    int spillers[14];
    ...
    /* The temporary for reloading reg3 should not clobber XMM0. */
...
static const uint8_t expected_code[] = {
    ...
    0x0F,0x2E,0x0C,0x24,                // ucomiss (%rsp),%xmm1
