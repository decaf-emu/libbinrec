...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_LOAD_IMM, reg4, 0, 0, 4));  // Spilled.
    int spillers[11];
    ...
    /* The temporary for saving RCX should not clobber EAX. */
    EXPECT(rtl_add_insn(unit, RTLOP_SLL, reg5, reg4, reg4, 0));
