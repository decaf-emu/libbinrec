...
static int add_rtl(RTLUnit *unit)
{
    ...
    /* RETURN should be treated like GOTO for the purpose of deciding
     * whether to align a following label. */
...
static const uint8_t expected_code[] = {
    ...
    0x33,0xC0,                          // xor %eax,%eax
    0x33,0xC0,                          // xor %eax,%eax
    0xE9,0x0F,0x00,0x00,0x00,           // jmp epilogue
    0x66,0x0F,0x1F,0x44,0x00,0x00,      // nopw 0(%rax,%rax)
