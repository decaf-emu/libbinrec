...
static int add_rtl(RTLUnit *unit)
{
    ...
    /* When the value to be tested is spilled, SEQI generates a cmp even
     * for a zero immediate, so the cmp for SLTSI can be optimized out. */
...
static const uint8_t expected_code[] = {
    ...
    0x45,0x0F,0xB6,0xF6,                // movzbl %r14b,%r14d
    0x41,0x0F,0x9C,0xC6,                // setl %r14b
    0x45,0x0F,0xB6,0xF6,                // movzbl %r14b,%r14d
