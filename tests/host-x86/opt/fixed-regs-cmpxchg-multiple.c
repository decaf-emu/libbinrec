...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_CMPXCHG, reg8, reg5, reg6, reg7));
    EXPECT(rtl_add_insn(unit, RTLOP_NOP, 0, reg5, reg6, 0));
    EXPECT(rtl_add_insn(unit, RTLOP_NOP, 0, reg7, 0, 0));

    EXPECT(rtl_add_insn(unit, RTLOP_NOP, 0, reg4, reg8, 0));
