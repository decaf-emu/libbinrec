...
{
    for (int i = 0; i < 8; i++) {
        EXPECT(rtl_alloc_alias_register(unit, RTLTYPE_V2_FLOAT64));
    }
...
static const uint8_t expected_code[] = {
    ...
    0xF3,0x44,0x0F,0x11,0xAC,0x24,0x80, // movss %xmm13,128(%rsp)
      0x00,0x00,0x00,
    0xB8,0x00,0x00,0x80,0x40,           // mov $0x40800000,%eax
    0x66,0x44,0x0F,0x6E,0xE8,           // movd %eax,%xmm13
    0x45,0x0F,0x28,0xEC,                // movaps %xmm12,%xmm13
    0xC4,0x62,0x09,0x99,0xAC,0x24,0x80, // vfmadd132ss 128(%rsp),%xmm14,%xmm13
      0x00,0x00,0x00,
