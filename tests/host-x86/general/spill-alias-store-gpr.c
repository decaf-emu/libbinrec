...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_SET_ALIAS, 0, regs[13], 0, alias));
...
static const uint8_t expected_code[] = {
    ...
    0x44,0x89,0x74,0x24,0x04,           // mov %r14d,4(%rsp)
    0x41,0xBE,0x0F,0x00,0x00,0x00,      // mov $15,%r14d
    0x44,0x8B,0x7C,0x24,0x04,           // mov 4(%rsp),%r15d
    0x44,0x89,0x3C,0x24,                // mov %r15d,(%rsp)
