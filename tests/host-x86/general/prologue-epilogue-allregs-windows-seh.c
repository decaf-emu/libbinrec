...
int main(void)
{
    ...
    static const uint8_t expected_code[] = {
        ...
        0x01,0x52,0x1E,0x00,            // UNWIND_INFO
        0x49,0xF8,0x09,0x00,            // 0x49: UWOP_SAVE_XMM128 xmm15,9
        0x40,0xE8,0x08,0x00,            // 0x40: UWOP_SAVE_XMM128 xmm14,8
        0x3A,0xD8,0x07,0x00,            // 0x3A: UWOP_SAVE_XMM128 xmm13,7
        0x34,0xC8,0x06,0x00,            // 0x34: UWOP_SAVE_XMM128 xmm12,6
        0x2E,0xB8,0x05,0x00,            // 0x2E: UWOP_SAVE_XMM128 xmm11,5
        0x28,0xA8,0x04,0x00,            // 0x28: UWOP_SAVE_XMM128 xmm10,4
        0x22,0x98,0x03,0x00,            // 0x22: UWOP_SAVE_XMM128 xmm9,3
        0x1C,0x88,0x02,0x00,            // 0x1C: UWOP_SAVE_XMM128 xmm8,2
        0x17,0x78,0x01,0x00,            // 0x17: UWOP_SAVE_XMM128 xmm7,1
        0x13,0x68,0x00,0x00,            // 0x13: UWOP_SAVE_XMM128 xmm6,0
        0x0C,0x01,0x14,0x00,            // 0x0C: UWOP_ALLOC_LARGE 0,20
        ...
        0x41,0x56,                      // push %r14
        0x41,0x57,                      // push %r15
        0x48,0x81,0xEC,0xA8,0x00,0x00,  // sub $168,%rsp
          0x00,
        ...
        0x44,0x0F,0x29,0xB4,0x24,0x80,  // movaps %xmm14,128(%rsp)
          0x00,0x00,0x00,
        0x44,0x0F,0x29,0xBC,0x24,0x90,  // movaps %xmm15,144(%rsp)
          0x00,0x00,0x00,
        /* End of prologue, beginning of epilogue. */
        0x44,0x0F,0x28,0xBC,0x24,0x90,  // movaps %xmm15,144(%rsp)
          0x00,0x00,0x00,
        0x44,0x0F,0x28,0xB4,0x24,0x80,  // movaps %xmm14,128(%rsp)
          0x00,0x00,0x00,
        ...
        0x48,0x81,0xC4,0xA8,0x00,0x00,  // add $168,%rsp
          0x00,
        0x41,0x5F,                      // pop %r15
        0x41,0x5E,                      // pop %r14
        0x41,0x5D,                      // pop %r13
