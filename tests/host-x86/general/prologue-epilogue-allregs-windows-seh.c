...
int main(void)
{
    ...
    static const uint8_t expected_code[] = {
        ...
        0x01,0x50,0x1D,0x00,            // UNWIND_INFO
        0x47,0xF8,0x09,0x00,            // 0x49: UWOP_SAVE_XMM128 xmm15,9
        ...
        0x0A,0x01,0x13,0x00,            // 0x0C: UWOP_ALLOC_LARGE 0,19
        ...
        0x41,0x55,                      // push %r13
        0x41,0x56,                      // push %r14
        0x48,0x81,0xEC,0xA0,0x00,0x00,  // sub $160,%rsp
          0x00,
        ...
        0x48,0x81,0xC4,0xA0,0x00,0x00,  // add $160,%rsp
          0x00,
        0x41,0x5E,                      // pop %r14
        0x41,0x5D,                      // pop %r13
        0x41,0x5C,                      // pop %r12
