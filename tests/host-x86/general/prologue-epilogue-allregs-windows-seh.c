...
int main(void)
{
    ...
    static const uint8_t expected_code[] = {
        ...
        0x01,0x47,0x1B,0x00,            // UNWIND_INFO
        0x3E,0xE8,0x08,0x00,            // 0x40: UWOP_SAVE_XMM128 xmm14,8
        ...
        0x0A,0x01,0x11,0x00,            // 0x0C: UWOP_ALLOC_LARGE 0,17
        ...
        0x41,0x55,                      // push %r13
        0x41,0x56,                      // push %r14
        0x48,0x81,0xEC,0x90,0x00,0x00,  // sub $144,%rsp
          0x00,
        ...
        0x44,0x0F,0x28,0xB4,0x24,0x80,  // movaps 128(%rsp),%xmm14
          0x00,0x00,0x00,
        0x44,0x0F,0x28,0x6C,0x24,0x70,  // movaps 112(%rsp),%xmm13
        0x44,0x0F,0x28,0x64,0x24,0x60,  // movaps 96(%rsp),%xmm12
        0x44,0x0F,0x28,0x5C,0x24,0x50,  // movaps 80(%rsp),%xmm11
        0x44,0x0F,0x28,0x54,0x24,0x40,  // movaps 64(%rsp),%xmm10
        0x44,0x0F,0x28,0x4C,0x24,0x30,  // movaps 48(%rsp),%xmm9
        0x44,0x0F,0x28,0x44,0x24,0x20,  // movaps 32(%rsp),%xmm8
        0x0F,0x28,0x7C,0x24,0x10,       // movaps 16(%rsp),%xmm7
        0x0F,0x28,0x34,0x24,            // movaps (%rsp),%xmm6
        0x48,0x81,0xC4,0x90,0x00,0x00,  // add $144,%rsp
          0x00,
        0x41,0x5E,                      // pop %r14
        0x41,0x5D,                      // pop %r13
        0x41,0x5C,                      // pop %r12
