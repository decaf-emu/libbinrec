...
static const char expected[] =
    ...
    "  332: FCAST      r227, r6\n"
    "  333: VBROADCAST r228, r227\n"
    "  334: SET_ALIAS  a3, r228\n"
    "  335: GOTO       L31\n"
    "  336: LABEL      L30\n"
    "  337: VBUILD2    r229, r122, r218\n"
    "  338: SET_ALIAS  a3, r229\n"
    "  339: GOTO       L31\n"
    "  340: LABEL      L3\n"
    "  341: GET_ALIAS  r230, a6\n"
    "  342: FGETSTATE  r231\n"
    "  343: FCLEAREXC  r232, r231\n"
    "  344: FSETSTATE  r232\n"
    "  345: VFCVT      r233, r10\n"
    "  346: SET_ALIAS  a3, r233\n"
    "  347: VEXTRACT   r234, r10, 0\n"
    "  348: BITCAST    r235, r234\n"
    "  349: SGTUI      r236, r235, 0\n"
    "  350: SRLI       r237, r235, 31\n"
    "  351: BFEXT      r241, r235, 23, 8\n"
    "  352: SEQI       r238, r241, 0\n"
    "  353: SEQI       r239, r241, 255\n"
    "  354: SLLI       r242, r235, 9\n"
    "  355: SEQI       r240, r242, 0\n"
    "  356: AND        r243, r238, r240\n"
    "  357: XORI       r244, r240, 1\n"
    "  358: AND        r245, r239, r244\n"
    "  359: AND        r246, r238, r236\n"
    "  360: OR         r247, r246, r245\n"
    "  361: OR         r248, r243, r245\n"
    "  362: XORI       r249, r248, 1\n"
    "  363: XORI       r250, r237, 1\n"
    "  364: AND        r251, r237, r249\n"
    "  365: AND        r252, r250, r249\n"
    "  366: SLLI       r253, r247, 4\n"
    "  367: SLLI       r254, r251, 3\n"
    "  368: SLLI       r255, r252, 2\n"
    "  369: SLLI       r256, r243, 1\n"
    "  370: OR         r257, r253, r254\n"
    "  371: OR         r258, r255, r256\n"
    "  372: OR         r259, r257, r239\n"
    "  373: OR         r260, r259, r258\n"
    "  374: FTESTEXC   r261, r231, INEXACT\n"
    "  375: SLLI       r262, r261, 5\n"
    "  376: OR         r263, r260, r262\n"
    "  377: GET_ALIAS  r264, a6\n"
    "  378: BFINS      r265, r264, r263, 12, 7\n"
    "  379: SET_ALIAS  a6, r265\n"
    "  380: GOTO_IF_Z  r261, L33\n"
    "  381: GET_ALIAS  r266, a6\n"
    "  382: NOT        r267, r266\n"
    "  383: ORI        r268, r266, 33554432\n"
    "  384: ANDI       r269, r267, 33554432\n"
    "  385: SET_ALIAS  a6, r268\n"
    "  386: GOTO_IF_Z  r269, L34\n"
    "  387: ORI        r270, r268, -2147483648\n"
    "  388: SET_ALIAS  a6, r270\n"
    "  389: LABEL      L34\n"
    "  390: LABEL      L33\n"
    "  391: FTESTEXC   r271, r231, OVERFLOW\n"
    "  392: GOTO_IF_Z  r271, L35\n"
    "  393: GET_ALIAS  r272, a6\n"
    "  394: NOT        r273, r272\n"
    "  395: ORI        r274, r272, 268435456\n"
    "  396: ANDI       r275, r273, 268435456\n"
    "  397: SET_ALIAS  a6, r274\n"
    "  398: GOTO_IF_Z  r275, L36\n"
    "  399: ORI        r276, r274, -2147483648\n"
    "  400: SET_ALIAS  a6, r276\n"
    "  401: LABEL      L36\n"
    "  402: LABEL      L35\n"
    "  403: FTESTEXC   r277, r231, UNDERFLOW\n"
    "  404: GOTO_IF_Z  r277, L32\n"
    "  405: GET_ALIAS  r278, a6\n"
    "  406: NOT        r279, r278\n"
    "  407: ORI        r280, r278, 134217728\n"
    "  408: ANDI       r281, r279, 134217728\n"
    "  409: SET_ALIAS  a6, r280\n"
    "  410: GOTO_IF_Z  r281, L37\n"
    "  411: ORI        r282, r280, -2147483648\n"
    "  412: SET_ALIAS  a6, r282\n"
    "  413: LABEL      L37\n"
    "  414: LABEL      L32\n"
    "  415: LABEL      L31\n"
    "  416: LOAD_IMM   r283, 8\n"
    "  417: SET_ALIAS  a1, r283\n"
    "  418: RETURN\n"
    "\n"
    ...
    "Block 56: 55,38,39,43,52 --> [319,331] --> 57,58\n"
    "Block 57: 56 --> [332,335] --> 72\n"
    "Block 58: 56 --> [336,339] --> 72\n"
    "Block 59: 3 --> [340,380] --> 60,63\n"
    ...
    "Block 67: 66,63 --> [402,404] --> 68,71\n"
    "Block 68: 67 --> [405,410] --> 69,70\n"
    "Block 69: 68 --> [411,412] --> 70\n"
    "Block 70: 69,68 --> [413,413] --> 71\n"
    "Block 71: 70,67 --> [414,414] --> 72\n"
    "Block 72: 71,57,58 --> [415,418] --> <none>\n"
    ;
