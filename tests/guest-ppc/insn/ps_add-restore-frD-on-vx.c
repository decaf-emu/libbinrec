...
static const char expected[] =
    ...
    "  323: FSETSTATE  r210\n"
    "  324: FTESTEXC   r211, r209, INVALID\n"
    "  325: GOTO_IF_Z  r211, L32\n"
    "  326: NOT        r212, r208\n"
    "  327: ORI        r213, r208, 16777216\n"
    "  328: ANDI       r214, r212, 16777216\n"
    "  329: SET_ALIAS  a6, r213\n"
    "  330: GOTO_IF_Z  r214, L33\n"
    "  331: ORI        r215, r213, -2147483648\n"
    "  332: SET_ALIAS  a6, r215\n"
    "  333: LABEL      L33\n"
    "  334: ANDI       r216, r208, 128\n"
    "  335: GOTO_IF_Z  r216, L32\n"
    "  336: GET_ALIAS  r217, a7\n"
    "  337: ANDI       r218, r217, 31\n"
    "  338: SET_ALIAS  a7, r218\n"
    "  339: GOTO       L34\n"
    "  340: LABEL      L32\n"
    "  341: VFCVT      r219, r12\n"
    "  342: SET_ALIAS  a3, r219\n"
    "  343: VEXTRACT   r220, r12, 0\n"
    "  344: BITCAST    r221, r220\n"
    "  345: SGTUI      r222, r221, 0\n"
    "  346: SRLI       r223, r221, 31\n"
    "  347: BFEXT      r227, r221, 23, 8\n"
    "  348: SEQI       r224, r227, 0\n"
    "  349: SEQI       r225, r227, 255\n"
    "  350: SLLI       r228, r221, 9\n"
    "  351: SEQI       r226, r228, 0\n"
    "  352: AND        r229, r224, r226\n"
    "  353: XORI       r230, r226, 1\n"
    "  354: AND        r231, r225, r230\n"
    "  355: AND        r232, r224, r222\n"
    "  356: OR         r233, r232, r231\n"
    "  357: OR         r234, r229, r231\n"
    "  358: XORI       r235, r234, 1\n"
    "  359: XORI       r236, r223, 1\n"
    "  360: AND        r237, r223, r235\n"
    "  361: AND        r238, r236, r235\n"
    "  362: SLLI       r239, r233, 4\n"
    "  363: SLLI       r240, r237, 3\n"
    "  364: SLLI       r241, r238, 2\n"
    "  365: SLLI       r242, r229, 1\n"
    "  366: OR         r243, r239, r240\n"
    "  367: OR         r244, r241, r242\n"
    "  368: OR         r245, r243, r225\n"
    "  369: OR         r246, r245, r244\n"
    "  370: FTESTEXC   r247, r209, INEXACT\n"
    "  371: SLLI       r248, r247, 5\n"
    "  372: OR         r249, r246, r248\n"
    "  373: SET_ALIAS  a7, r249\n"
    "  374: GOTO_IF_Z  r247, L35\n"
    "  375: GET_ALIAS  r250, a6\n"
    "  376: NOT        r251, r250\n"
    "  377: ORI        r252, r250, 33554432\n"
    "  378: ANDI       r253, r251, 33554432\n"
    "  379: SET_ALIAS  a6, r252\n"
    "  380: GOTO_IF_Z  r253, L36\n"
    "  381: ORI        r254, r252, -2147483648\n"
    "  382: SET_ALIAS  a6, r254\n"
    "  383: LABEL      L36\n"
    "  384: LABEL      L35\n"
    "  385: FTESTEXC   r255, r209, OVERFLOW\n"
    "  386: GOTO_IF_Z  r255, L37\n"
    "  387: GET_ALIAS  r256, a6\n"
    "  388: NOT        r257, r256\n"
    "  389: ORI        r258, r256, 268435456\n"
    "  390: ANDI       r259, r257, 268435456\n"
    "  391: SET_ALIAS  a6, r258\n"
    "  392: GOTO_IF_Z  r259, L38\n"
    "  393: ORI        r260, r258, -2147483648\n"
    "  394: SET_ALIAS  a6, r260\n"
    "  395: LABEL      L38\n"
    "  396: LABEL      L37\n"
    "  397: FTESTEXC   r261, r209, UNDERFLOW\n"
    "  398: GOTO_IF_Z  r261, L34\n"
    "  399: GET_ALIAS  r262, a6\n"
    "  400: NOT        r263, r262\n"
    "  401: ORI        r264, r262, 134217728\n"
    "  402: ANDI       r265, r263, 134217728\n"
    "  403: SET_ALIAS  a6, r264\n"
    "  404: GOTO_IF_Z  r265, L39\n"
    "  405: ORI        r266, r264, -2147483648\n"
    "  406: SET_ALIAS  a6, r266\n"
    "  407: LABEL      L39\n"
    "  408: LABEL      L34\n"
    "  409: LABEL      L31\n"
    "  410: LOAD_IMM   r267, 8\n"
    "  411: SET_ALIAS  a1, r267\n"
    "  412: GET_ALIAS  r268, a6\n"
    "  413: GET_ALIAS  r269, a7\n"
    "  414: ANDI       r270, r268, -1611134977\n"
    "  415: SLLI       r271, r269, 12\n"
    "  416: OR         r272, r270, r271\n"
    "  417: SET_ALIAS  a6, r272\n"
    "  418: RETURN\n"
    "\n"
    ...
    "Block 57: 56 --> [311,314] --> 77\n"
    "Block 58: 56 --> [315,318] --> 77\n"
    "Block 59: 3 --> [319,325] --> 60,64\n"
    "Block 60: 59 --> [326,330] --> 61,62\n"
    "Block 61: 60 --> [331,332] --> 62\n"
    "Block 62: 61,60 --> [333,335] --> 63,64\n"
    "Block 63: 62 --> [336,339] --> 76\n"
    "Block 64: 59,62 --> [340,374] --> 65,68\n"
    "Block 65: 64 --> [375,380] --> 66,67\n"
    "Block 66: 65 --> [381,382] --> 67\n"
    "Block 67: 66,65 --> [383,383] --> 68\n"
    "Block 68: 67,64 --> [384,386] --> 69,72\n"
    "Block 69: 68 --> [387,392] --> 70,71\n"
    "Block 70: 69 --> [393,394] --> 71\n"
    "Block 71: 70,69 --> [395,395] --> 72\n"
    "Block 72: 71,68 --> [396,398] --> 73,76\n"
    "Block 73: 72 --> [399,404] --> 74,75\n"
    "Block 74: 73 --> [405,406] --> 75\n"
    "Block 75: 74,73 --> [407,407] --> 76\n"
    "Block 76: 75,63,72 --> [408,408] --> 77\n"
    "Block 77: 76,57,58 --> [409,418] --> <none>\n"
    ;
