...
static const char expected[] =
    ...
    "   20: ZCAST      r17, r10\n"
    "   21: LOAD_IMM   r18, 0x0\n"
    "   22: SET_ALIAS  a35, r18\n"
    "   23: LOAD_IMM   r19, 0xC\n"
    "   24: SET_ALIAS  a36, r19\n"
    "   25: LABEL      L4\n"
    "   26: GET_ALIAS  r20, a35\n"
    "   27: SLTU       r21, r20, r17\n"
    "   28: GOTO_IF_Z  r21, L5\n"
    "   29: GET_ALIAS  r22, a36\n"
    "   30: ADD        r23, r8, r20\n"
    "   31: XORI       r24, r22, 3\n"
    "   32: ADD        r25, r1, r24\n"
    "   33: LOAD_U8    r26, 0(r23)\n"
    "   34: STORE_I8   256(r25), r26\n"
    "   35: ADDI       r27, r20, 1\n"
    "   36: SET_ALIAS  a35, r27\n"
    "   37: ADDI       r28, r22, 1\n"
    "   38: ANDI       r29, r28, 127\n"
    "   39: SET_ALIAS  a36, r29\n"
    "   40: GOTO       L4\n"
    "   41: LABEL      L5\n"
    "   42: LOAD_IMM   r30, 4\n"
    "   43: SET_ALIAS  a1, r30\n"
    ...
    "Block 2: 1 --> [13,18] --> 3\n"
    "Block 3: 2,1 --> [19,24] --> 4\n"
    "Block 4: 3,5 --> [25,28] --> 5,6\n"
    "Block 5: 4 --> [29,40] --> 4\n"
    "Block 6: 4 --> [41,43] --> 7\n"
    "Block 7: 6 --> [44,45] --> <none>\n"
    ;
