...
static const uint8_t input[] = {
    ...
    0x6C,0x63,0x00,0x01,  // xoris r3,r3,1
...
static const char expected[] =
        ...
        "[info] Failed to optimize possible signed fcfi at 0x20: low word store is not the result of xoris ...,0x8000\n"
    ...
    "\n"
    "Block 0: <none> --> [0,36] --> 2\n"
    "Block 1: <none> --> [37,38] --> 2\n"
    "Block 2: 1,0 --> [39,40] --> <none>\n"
    ;
