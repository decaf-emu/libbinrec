...
static const uint8_t input[] = {
    ...
    0x90,0x01,0xFF,0xF8,  // stw r0,-8(r1)
    0x90,0x61,0xFF,0xFC,  // stw r3,-4(r1)
    0xC8,0x41,0xFF,0xF8,  // lfd f2,-8(r1)
...
static const char expected[] =
        ...
        "[info] Failed to optimize possible fcfi at 0x1C: frA is not loaded from the local stack frame\n"
