...
int main(void)
{
    ...
    EXPECT_FALSE(rtl_add_insn(unit, RTLOP_FMADD, reg5, reg1, reg2, reg3));
    EXPECT_ICE("Operand constraint violated:"
    ...
    EXPECT_FALSE(rtl_add_insn(unit, RTLOP_FMADD, reg5, reg2, reg1, reg3));
    EXPECT_ICE("Operand constraint violated:"
    ...
    EXPECT_FALSE(rtl_add_insn(unit, RTLOP_FMADD, reg5, reg2, reg3, reg1));
    EXPECT_ICE("Operand constraint violated:"
