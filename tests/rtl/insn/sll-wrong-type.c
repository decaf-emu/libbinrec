...
int main(void)
{
    ...
    EXPECT_FALSE(rtl_add_insn(unit, RTLOP_SLL, reg5, reg1, reg2, 0));
    ...
    EXPECT_FALSE(rtl_add_insn(unit, RTLOP_SLL, reg4, reg2, reg1, 0));
    EXPECT_ICE("Operand constraint violated:"
    ...
    EXPECT_FALSE(rtl_add_insn(unit, RTLOP_SLL, reg4, reg1, reg3, 0));
    EXPECT_ICE("Operand constraint violated:"
