...
int main(void)
{
    ...
    for (int ordered = 0; ordered <= 1; ordered++) {
        for (int invert = 0; invert <= 1; invert++) {
            for (int cmp = RTLFCMP_LT; cmp <= RTLFCMP_EQ; cmp++, insn += 2) {
    ...
    const char *disassembly =
        ...
        "   11: MOVE       r12, r11\n"
        "           r11: fcmp(r1, r2, EQ)\n"
        "   12: FCMP       r13, r1, r2, NLT\n"
        "           r1: 1.0f\n"
        "           r2: 2.0f\n"
        "   13: MOVE       r14, r13\n"
        "           r13: fcmp(r1, r2, NLT)\n"
        "   14: FCMP       r15, r1, r2, NLE\n"
        "           r1: 1.0f\n"
        "           r2: 2.0f\n"
        "   15: MOVE       r16, r15\n"
        "           r15: fcmp(r1, r2, NLE)\n"
        "   16: FCMP       r17, r1, r2, NGT\n"
        "           r1: 1.0f\n"
        "           r2: 2.0f\n"
        "   17: MOVE       r18, r17\n"
        "           r17: fcmp(r1, r2, NGT)\n"
        "   18: FCMP       r19, r1, r2, NGE\n"
        "           r1: 1.0f\n"
        "           r2: 2.0f\n"
        "   19: MOVE       r20, r19\n"
        "           r19: fcmp(r1, r2, NGE)\n"
        "   20: FCMP       r21, r1, r2, NEQ\n"
        "           r1: 1.0f\n"
        "           r2: 2.0f\n"
        "   21: MOVE       r22, r21\n"
        "           r21: fcmp(r1, r2, NEQ)\n"
        "   22: FCMP       r23, r1, r2, OLT\n"
        "           r1: 1.0f\n"
        "           r2: 2.0f\n"
        "   23: MOVE       r24, r23\n"
        "           r23: fcmp(r1, r2, OLT)\n"
        "   24: FCMP       r25, r1, r2, OLE\n"
        "           r1: 1.0f\n"
        "           r2: 2.0f\n"
        "   25: MOVE       r26, r25\n"
        "           r25: fcmp(r1, r2, OLE)\n"
        "   26: FCMP       r27, r1, r2, OGT\n"
        "           r1: 1.0f\n"
        "           r2: 2.0f\n"
        "   27: MOVE       r28, r27\n"
        "           r27: fcmp(r1, r2, OGT)\n"
        "   28: FCMP       r29, r1, r2, OGE\n"
        "           r1: 1.0f\n"
        "           r2: 2.0f\n"
        "   29: MOVE       r30, r29\n"
        "           r29: fcmp(r1, r2, OGE)\n"
        "   30: FCMP       r31, r1, r2, OEQ\n"
        "           r1: 1.0f\n"
        "           r2: 2.0f\n"
        "   31: MOVE       r32, r31\n"
        "           r31: fcmp(r1, r2, OEQ)\n"
        "   32: FCMP       r33, r1, r2, ONLT\n"
        "           r1: 1.0f\n"
        "           r2: 2.0f\n"
        "   33: MOVE       r34, r33\n"
        "           r33: fcmp(r1, r2, ONLT)\n"
        "   34: FCMP       r35, r1, r2, ONLE\n"
        "           r1: 1.0f\n"
        "           r2: 2.0f\n"
        "   35: MOVE       r36, r35\n"
        "           r35: fcmp(r1, r2, ONLE)\n"
        "   36: FCMP       r37, r1, r2, ONGT\n"
        "           r1: 1.0f\n"
        "           r2: 2.0f\n"
        "   37: MOVE       r38, r37\n"
        "           r37: fcmp(r1, r2, ONGT)\n"
        "   38: FCMP       r39, r1, r2, ONGE\n"
        "           r1: 1.0f\n"
        "           r2: 2.0f\n"
        "   39: MOVE       r40, r39\n"
        "           r39: fcmp(r1, r2, ONGE)\n"
        "   40: FCMP       r41, r1, r2, ONEQ\n"
        "           r1: 1.0f\n"
        "           r2: 2.0f\n"
        "   41: MOVE       r42, r41\n"
        "           r41: fcmp(r1, r2, ONEQ)\n"
