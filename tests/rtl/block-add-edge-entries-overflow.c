...
int main(void)
{
    ...
    EXPECT(rtl_block_add_edge(unit, 8, 0));
    EXPECT_EQ(unit->num_blocks, 10);
    EXPECT_EQ(unit->blocks[0].entries[0], 9);
    EXPECT_EQ(unit->blocks[0].entries[1], 8);
    ...
    EXPECT_EQ(unit->blocks[0].exits[0], 9);
    EXPECT_EQ(unit->blocks[0].exits[1], -1);
    EXPECT_EQ(unit->blocks[1].entries[0], -1);
    EXPECT_EQ(unit->blocks[1].exits[0], 9);
    EXPECT_EQ(unit->blocks[1].exits[1], -1);
    EXPECT_EQ(unit->blocks[2].entries[0], -1);
    EXPECT_EQ(unit->blocks[2].exits[0], 9);
    EXPECT_EQ(unit->blocks[2].exits[1], -1);
    EXPECT_EQ(unit->blocks[3].entries[0], -1);
    EXPECT_EQ(unit->blocks[3].exits[0], 9);
    EXPECT_EQ(unit->blocks[3].exits[1], -1);
    EXPECT_EQ(unit->blocks[4].entries[0], -1);
    EXPECT_EQ(unit->blocks[4].exits[0], 9);
    EXPECT_EQ(unit->blocks[4].exits[1], -1);
    EXPECT_EQ(unit->blocks[5].entries[0], -1);
    EXPECT_EQ(unit->blocks[5].exits[0], 9);
    EXPECT_EQ(unit->blocks[5].exits[1], -1);
    EXPECT_EQ(unit->blocks[6].entries[0], -1);
    EXPECT_EQ(unit->blocks[6].exits[0], 9);
    EXPECT_EQ(unit->blocks[6].exits[1], -1);
    EXPECT_EQ(unit->blocks[7].entries[0], 7);
    EXPECT_EQ(unit->blocks[7].entries[1], -1);
    EXPECT_EQ(unit->blocks[7].exits[0], 7);
    EXPECT_EQ(unit->blocks[7].exits[1], 9);
    EXPECT_EQ(unit->blocks[8].entries[0], -1);
    EXPECT_EQ(unit->blocks[8].exits[0], 0);
    EXPECT_EQ(unit->blocks[8].exits[1], -1);
    EXPECT_EQ(unit->blocks[9].entries[0], 0);
    EXPECT_EQ(unit->blocks[9].entries[1], 1);
    EXPECT_EQ(unit->blocks[9].entries[2], 2);
    EXPECT_EQ(unit->blocks[9].entries[3], 3);
    EXPECT_EQ(unit->blocks[9].entries[4], 4);
    EXPECT_EQ(unit->blocks[9].entries[5], 5);
    EXPECT_EQ(unit->blocks[9].entries[6], 6);
    EXPECT_EQ(unit->blocks[9].entries[7], 7);
    EXPECT_EQ(unit->blocks[9].exits[0], 0);
    EXPECT_EQ(unit->blocks[9].exits[1], -1);
    EXPECT_FALSE(unit->error);
    EXPECT_STREQ(get_log_messages(), NULL);
