...
int main(void)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_SEQI, reg3, reg1, 0, 0x7FFFFFFF));
    ...
    EXPECT_EQ(unit->insns[1].opcode, RTLOP_SEQI);
    ...
    EXPECT_EQ(unit->insns[2].opcode, RTLOP_SEQI);
    ...
    const char *disassembly =
        "    0: LOAD_IMM   r1, 10\n"
        "    1: SEQI       r2, r1, -2147483648\n"
        "           r1: 10\n"
        "    2: SEQI       r3, r1, 2147483647\n"
        "           r1: 10\n"
        "    3: MOVE       r4, r2\n"
        "           r2: r1 == -2147483648\n"
        "    4: MOVE       r5, r3\n"
