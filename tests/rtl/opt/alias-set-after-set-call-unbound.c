...
{
    int label, alias, reg1, reg2, reg3, reg4;
    ...
    /* This CALL should not block the SET_ALIAS above from being killed,
     * since the alias has no bound storage. */
...
static const char expected[] =
        ...
        "[info] Dropping dead store to a1 at 3\n"
