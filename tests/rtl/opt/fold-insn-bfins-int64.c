...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_LOAD_IMM,
                        reg2, 0, 0, UINT64_C(0xFEDCBA987654321)));
    EXPECT(reg3 = rtl_alloc_register(unit, RTLTYPE_ADDRESS));
    EXPECT(rtl_add_insn(unit, RTLOP_BFINS, reg3, reg1, reg2, 20 | 25<<8));
...
static const char expected[] =
        ...
        "[info] Folded r3 to constant value 0x1235654321BCDEF at insn 2\n"
        "[info] r1 no longer used, setting death = birth\n"
        "[info] r2 no longer used, setting death = birth\n"
    #endif
    "    0: LOAD_IMM   r1, 0x123456789ABCDEF\n"
    "    1: LOAD_IMM   r2, 0xFEDCBA987654321\n"
    "    2: LOAD_IMM   r3, 0x1235654321BCDEF\n"
    "\n"
