...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_LOAD_IMM,
                        reg1, 0, 0, UINT64_C(0xC1F00000000C0000)));
    EXPECT(reg2 = rtl_alloc_register(unit, RTLTYPE_INT64));
    EXPECT(rtl_add_insn(unit, RTLOP_FTRUNCI, reg2, reg1, 0, 0));
...
static const char expected[] =
        ...
        "[info] Folded r2 to constant value 0xFFFFFFFF00000000 at 1\n"
        "[info] r1 no longer used, setting death = birth\n"
    #endif
    "    0: LOAD_IMM   r1, -4294967296.75\n"
    "    1: LOAD_IMM   r2, 0xFFFFFFFF00000000\n"
    "\n"
