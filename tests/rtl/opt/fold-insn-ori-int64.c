...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_ORI, reg2, reg1, 0, -0x12345678));
...
static const char expected[] =
        ...
        "[info] Folded r2 to constant value 0xFFFFFFFFEFCFEF89 at insn 1\n"
        "[info] r1 no longer used, setting death = birth\n"
    #endif
    "    0: LOAD_IMM   r1, 0x123456789\n"
    "    1: LOAD_IMM   r2, 0xFFFFFFFFEFCFEF89\n"
    "\n"
