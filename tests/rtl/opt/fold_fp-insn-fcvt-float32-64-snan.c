...
static int add_rtl(RTLUnit *unit)
{
    ...
    EXPECT(rtl_add_insn(unit, RTLOP_LOAD_IMM, reg1, 0, 0, 0xFF800001));
...
static const char expected[] =
        ...
        "[info] Folded r2 to constant value 0xFFF8000020000000 at 1\n"
        "[info] r1 no longer used, setting death = birth\n"
    #endif
    "    0: LOAD_IMM   r1, -nan(0x1)\n"
    "    1: LOAD_IMM   r2, -nan(0x8000020000000)\n"
    "\n"
